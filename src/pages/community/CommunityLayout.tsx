...
export function CommunityLayout({ header, actions, children }: CommunityLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-night text-slate-100">
      <div className="absolute left-1/2 top-0 h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-brand/20 blur-[200px]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.05),transparent_60%)] opacity-80" />

      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col gap-10 px-6 pb-16 pt-10 lg:px-10">
